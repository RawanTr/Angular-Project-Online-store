...
@Component({
  selector: 'app-pricedesc',
  templateUrl: './pricedesc.component.html',
  styleUrls: ['./pricedesc.component.css']
})
export class PricedescComponent implements OnInit {
  Products: Article[]=[]
  filter:any='pricedesc'
